...
inline constexpr double MAPCHUNK_RADIUS =
...
struct MCLYFlags {
  ...
  uint32_t overbright : 1; // This will make the texture way brighter. Used for
                           // lava to make it "glow".
...
struct ENTRY_MCLY {
  ...
  uint32_t ofsAlpha = 0;
  uint32_t effectID =
      0xFFFF; // default value, see https://wowdev.wiki/ADT/v18#MCLY_sub-chunk
};
