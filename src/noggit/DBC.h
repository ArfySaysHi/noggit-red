...
public:
  SoundAmbienceDB() : DBCFile("DBFilesClient/SoundAmbience.dbc") {}
...
public:
  ZoneMusicDB() : DBCFile("DBFilesClient/ZoneMusic.dbc") {}
...
public:
  ZoneIntroMusicTableDB() : DBCFile("DBFilesClient/ZoneIntroMusicTable.dbc") {}
...
public:
  SoundEntriesDB() : DBCFile("DBFilesClient/SoundEntries.dbc") {}
...
public:
  WMOAreaTableDB() : DBCFile("DBFilesClient/WMOAreaTable.dbc") {}
  ...
  static const size_t Flags =
      9; // int CWorldMap::QueryOutdoors: rec.flags & 4 || rec.flags & 2. &0x18:
         // Minimap::s_singleExterior = true unless groupRec::flags & 0x20
