...
void leave(int sig) {
  ...
  case SIGABRT:
    sign = "SIGABRT";
    description = "Abnormal termination, such as instigated by the abort "
                  "function. (Abort.)";
    break;
  case SIGFPE:
    sign = "SIGFPE";
    description = "Erroneous arithmetic operation, such as divide by 0 or "
                  "overflow. (Floating point exception.)";
    break;
  case SIGILL:
    sign = "SIGILL";
    description = "An ‘invalid object program’ has been detected. This usually "
                  "means that there is an illegal instruction in the program. "
                  "(Illegal instruction.)";
    break;
  case SIGINT:
    sign = "SIGINT";
    description =
        "Interactive attention signal; on interactive systems this is usually "
        "generated by typing some ‘break-in’ key at the terminal. (Interrupt.)";
    break;
  case SIGSEGV:
    sign = "SIGSEGV";
    description = "Invalid storage access; most frequently caused by "
                  "attempting to store some value in an object pointed to by a "
                  "bad pointer. (Segment violation.)";
    break;
  case SIGTERM:
    sign = "SIGTERM";
  ...
  LogError << "There was an exception of type \"" << sign << "\"\n\""
           << description
           << "\".\nPlease excuse the inconvenience. You may want to report "
              "this error including the log to the developers.\n"
           << std::endl;
...
LONG WINAPI windows_exception_handler(EXCEPTION_POINTERS *ExceptionInfo) {
  ...
  case EXCEPTION_NONCONTINUABLE_EXCEPTION:
    LogError << "EXCEPTION_NONCONTINUABLE_EXCEPTION" << std::endl;
    break;
