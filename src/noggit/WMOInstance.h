...
public:
  ...
  WMOInstance(WMOInstance &&other)
      : SceneObject(other._type, other._context), wmo(std::move(other.wmo)),
        ...
        mUnknown(other.mUnknown), mNameset(other.mNameset),
  ...
  void draw(OpenGL::Scoped::use_program &wmo_shader,
            ...
            bool draw_fog, std::vector<selection_type> selection, int animtime,
            bool world_has_skies, display_mode display, bool no_cull = false,
