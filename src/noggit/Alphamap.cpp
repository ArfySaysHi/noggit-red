...
Alphamap::Alphamap(BlizzardArchive::ClientFile *f, unsigned int flags,
...
void Alphamap::readNotCompressed(BlizzardArchive::ClientFile *f,
...
std::vector<uint8_t> Alphamap::compress() const {
  ...
  for (; current != end; ++current) {
    ...
    if (fill) {
      ...
      compressed_mcal_entry *e(
          reinterpret_cast<compressed_mcal_entry *>(&*(result.rbegin() + 1)));
