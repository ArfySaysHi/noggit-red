...
template <typename O, typename... Ts> class lua_function {
public:
  lua_function(O *obj, std::string const &func) : _obj(obj), _func(func) {}
...
#define LUA_MEMBER_FUNC(selftype, type, name)                                  \
  lua_function<selftype, type> name = lua_function<selftype, type>(this, #name);
} // namespace Scripting
} // namespace Noggit