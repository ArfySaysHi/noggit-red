...
enum class ActionObjectTypes { WMO, M2 };
...
public:
  ...
  bool checkAdressTag(std::uintptr_t address) {
    return std::find(_address_tag.begin(), _address_tag.end(), address) !=
           _address_tag.end();
  };
...
private:
  ...
  MapView *_map_view;
  std::vector<std::pair<MapChunk *, std::array<float, 145 * 3>>>
      _chunk_terrain_pre;
  std::vector<std::pair<MapChunk *, std::array<float, 145 * 3>>>
      _chunk_terrain_post;
  ...
  std::vector<std::pair<MapChunk *, std::array<float, 145 * 3>>>
      _chunk_vertex_color_pre;
  std::vector<std::pair<MapChunk *, std::array<float, 145 * 3>>>
      _chunk_vertex_color_post;
  std::vector<std::pair<unsigned, ObjectInstanceCache>>
      _transformed_objects_pre;
  std::vector<std::pair<unsigned, ObjectInstanceCache>>
      _transformed_objects_post;
  ...
  std::vector<std::pair<MapChunk *, std::vector<LiquidLayer>>>
      _chunk_liquid_pre;
  std::vector<std::pair<MapChunk *, std::vector<LiquidLayer>>>
      _chunk_liquid_post;
  ...
  std::vector<std::pair<MapChunk *, std::array<std::uint8_t, 64 * 64>>>
      _chunk_shadow_map_pre;
  std::vector<std::pair<MapChunk *, std::array<std::uint8_t, 64 * 64>>>
      _chunk_shadow_map_post;
