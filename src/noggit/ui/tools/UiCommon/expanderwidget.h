...
class ExpanderWidget : public QWidget {
  Q_OBJECT
  Q_PROPERTY(QString expanderTitle READ expanderTitle WRITE setExpanderTitle
                 STORED true)
  Q_PROPERTY(bool isExpanded READ isExpanded WRITE setExpanded STORED true)
  Q_PROPERTY(
      QIcon collapsedIcon READ collapsedIcon WRITE setCollapsedIcon STORED true)
  Q_PROPERTY(
      QIcon expandedIcon READ expandedIcon WRITE setExpandedIcon STORED true)
  Q_PROPERTY(
      QString settingsKey READ settingsKey WRITE setSettingsKey STORED true)
