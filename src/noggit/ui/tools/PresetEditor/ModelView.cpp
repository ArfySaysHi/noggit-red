...
void ModelViewer::paintGL() {
  ...
  if (_world) {
    _world->renderer()->draw(
        world_model_view(), world_projection(), glm::vec3(0.f, 0.f, 0.f), 0.f,
        glm::vec4(1.f, 1.f, 1.f, 1.f), CursorType::CIRCLE, 0.f, false, false,
        false, 0.3f, 0.f, glm::vec3(0.f, 0.f, 0.f), 0.f, 0.f, false, false,
        false, editing_mode::ground, _world_camera.position, true, false, true,
        true, true, true, true, true, false, true, &_settings_unused, false,
        eTerrainType::eTerrainType_Flat, 0, display_mode::in_3D
