...
enum GizmoContext { MAP_VIEW, PRESET_EDITOR };

enum GizmoInternalMode { MODEL, WMO, MULTISELECTION };

// This class is intended to be used by QOpenGLWidget presenting an ImGui
// drawing context. To use pass the context via setImGuiContext() in
// initializeGL() of a QOpenGLWidget and call the required gizmo method in
// paintGL()
