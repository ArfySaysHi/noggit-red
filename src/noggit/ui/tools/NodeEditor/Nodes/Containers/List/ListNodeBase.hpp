...
protected:
  ...
  QStringList _type_list = {
      "Integer",    "Unsigned Integer", "Boolean",  "Decimal",   "String",
      "Vector2D",   "Vector3D",         "Vector4D", "Matrix4x4", "Matrix3x3",
      "Quaternion", "Procedure",        "Color",    "Noise",     "Image"};
};
