...
GetVariableNodeBase::GetVariableNodeBase() : LogicNodeBase() {
...
void GetVariableNodeBase::compute() {
  ...
  auto variable_name =
      _in_ports[1].connected
          ? static_cast<StringData *>(_in_ports[1].in_value.lock().get())
                ->value()
...
void GetVariableNodeBase::outputConnectionCreated(
...
GetVariableNode::GetVariableNode() : GetVariableNodeBase() {
...
GetContextVariableNode::GetContextVariableNode() : GetVariableNodeBase() {
