...
HasTileAtPosNode::HasTileAtPosNode() : ContextLogicNodeBase() {
...
void HasTileAtPosNode::compute() {
  ...
  _out_ports[1].out_value = std::make_shared<BooleanData>(
      world->mapIndex.hasTile(glm::vec3(pos.x, pos.y, pos.z)));
