...
ChunkAddTextureNode::ChunkAddTextureNode() : ContextLogicNodeBase() {
...
void ChunkAddTextureNode::compute() {
  ...
  _out_ports[1].out_value = std::make_shared<IntegerData>(
      chunk->texture_set->get_texture_index_or_add(b_tex, 1));
