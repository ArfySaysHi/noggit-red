...
public:
  LightViewPixmap(QSize Size = QSize(LIGHT_VIEW_PREVIEW_WIDTH,
                                     LIGHT_VIEW_PREVIEW_HEIGHT),
...
public:
  LightViewArrow(QSize Size = QSize(LIGHT_VIEW_PREVIEW_WIDTH,
                                    LIGHT_VIEW_PREVIEW_HEIGHT),
                 QWidget *parent = nullptr);
...
public:
  LightViewDayIndicator(QSize Size = QSize(LIGHT_VIEW_PREVIEW_WIDTH,
                                           LIGHT_VIEW_PREVIEW_HEIGHT),
                        QWidget *parent = nullptr);
...
public:
  LightViewEditor(MapView *Map, SkyParam *Sky, SkyColorNames eSkyColor,
                  QWidget *parent = nullptr);
...
public:
  LightViewPreview(QSize Size = QSize(LIGHT_VIEW_PREVIEW_WIDTH,
                                      LIGHT_VIEW_PREVIEW_HEIGHT),
                   QWidget *parent = nullptr);
  LightViewPreview(QString LightName,
                   QSize Size = QSize(LIGHT_VIEW_PREVIEW_WIDTH,
                                      LIGHT_VIEW_PREVIEW_HEIGHT),
                   QWidget *parent = nullptr);
  void ShowLines(bool show);
