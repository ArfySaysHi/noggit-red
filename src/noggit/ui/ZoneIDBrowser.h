...
static std::map<int, std::string> area_flags_names = {
    ...
    // {10, "Force this area when on a Dynamic Transport"}, // From Classic TBC
    // definitions, probably changed around CATA
    ...
    // {28, "No Local Defense Channel"}, // From Classic TBC definitions,
    // probably chanegd around CATA
