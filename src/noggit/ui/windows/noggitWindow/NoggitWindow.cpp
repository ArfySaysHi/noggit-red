...
void NoggitWindow::enterMapAt(glm::vec3 pos, math::degrees camera_pitch,
  ...
  if (_world->mapIndex.hasAGlobalWMO()) {
    ...
    auto min_extent = glm::vec3(_world->mWmoEntry.extents[0][0],
                                _world->mWmoEntry.extents[0][1],
                                _world->mWmoEntry.extents[0][2]);
    auto max_extent = glm::vec3(_world->mWmoEntry.extents[1][0],
                                _world->mWmoEntry.extents[1][1] * 2,
                                _world->mWmoEntry.extents[1][2]);
  ...
  _map_view = (new MapView(camera_yaw, camera_pitch, pos, this, _project,
                           std::move(_world), uid_fix, from_bookmark));
