...
MapListItem::MapListItem(const MapListData &data, QWidget *parent = nullptr)
  ...
  _map_icon->setStyleSheet(
      "QLabel#project-icon-label { font-size: 12px; padding: 0px;}");
  ...
  _map_instance_type->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                                   Qt::AlignVCenter);
  _map_instance_type->setObjectName("project-information");
  _map_instance_type->setStyleSheet(
      "QLabel#project-information { font-size: 10px; }");
  ...
  if (_map_data.pinned) {
    ...
    _map_pinned_label->setPixmap(
        FontAwesomeIcon(FontAwesome::star).pixmap(QSize(16, 16)));
    _map_pinned_label->setGeometry(150, 0, 125, 20);
    _map_pinned_label->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                                    Qt::AlignVCenter);
    _map_pinned_label->setObjectName("project-pinned");
    _map_pinned_label->setStyleSheet(
        "QLabel#project-pinned { font-size: 10px; }");
...
QSize MapListItem::minimumSizeHint() const { return QSize(300, 32); }
