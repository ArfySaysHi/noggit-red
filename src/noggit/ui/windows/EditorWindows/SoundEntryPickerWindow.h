...
class SoundFileWListWidgetItem : public QWidget {
  Q_OBJECT
public:
  SoundFileWListWidgetItem(QLineEdit *filename_ledit, std::string dirpath,
...
private:
  ...
  // TODO sound advanced. shouldn't use a picker as it is unique for each sound,
  // just add an optional advanced layout without maybe a checkbox. maybe it is
  // in a separate tab ?
