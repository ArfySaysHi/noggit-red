...
public:
  std::shared_ptr<Project::NoggitProject>
  loadProject(Noggit::Ui::Windows::NoggitProjectSelectionWindow *parent) {
    ...
    if (is_case_sensitive_fs) {
      ...
      QDirIterator it(project_path, QDir::AllEntries | QDir::NoDotAndDotDot,
      ...
      if (has_uppercase) {
        ...
        prompt.setText("Your project contains upper-case named files, "
                       "which won't be visible to Noggit running on your OS "
        ...
        case QMessageBox::AcceptRole: {
          ...
          std::sort(incorrect_paths.begin(), incorrect_paths.end(),
                    std::greater<QString>{});
    ...
    auto project =
        application_project_service.loadProject(project_path.toStdString());
