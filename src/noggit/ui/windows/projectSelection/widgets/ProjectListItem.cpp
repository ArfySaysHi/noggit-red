...
ProjectListItem::ProjectListItem(const ProjectListItemData &data,
  ...
  _project_name_label->setStyleSheet(
      "QLabel#project-title-label { font-size: 15px; }");
  ...
  _project_last_edited_label->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                                           Qt::AlignVCenter);
...
QSize ProjectListItem::minimumSizeHint() const { return QSize(125, 55); }
