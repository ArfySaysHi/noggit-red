...
public:
  ...
  void draw(glm::mat4x4 const &model_view, glm::mat4x4 const &projection,
            ...
            glm::vec4 const &cursor_color, CursorType cursor_type,
            ...
            bool draw_terrain, bool draw_wmo, bool draw_water,
            bool draw_wmo_doodads, bool draw_models, bool draw_model_animations,
            bool draw_models_with_box, bool draw_hidden_models,
            MinimapRenderSettings *minimap_render_settings, bool draw_fog,
            eTerrainType ground_editing_brush, int water_layer,
            display_mode display, bool draw_occlusion_boxes = false,
            bool minimap_render = false, bool draw_wmo_exterior = true);

  bool saveMinimap(TileIndex const &tile_idx, MinimapRenderSettings *settings,
...
private:
  void drawMinimap(MapTile *tile, glm::mat4x4 const &model_view,
                   glm::mat4x4 const &projection, glm::vec3 const &camera_pos,
  ...
  std::unique_ptr<Noggit::MapHorizon::render> _horizon_render;
