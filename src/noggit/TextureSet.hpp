...
public:
  ...
  bool replace_texture(scoped_blp_texture_reference const &texture_to_replace,
                       scoped_blp_texture_reference replacement_texture);
  [[nodiscard]] bool paintTexture(float xbase, float zbase, float x, float z,
                                  Brush *brush, float strength, float pressure,
                                  scoped_blp_texture_reference texture);
  [[nodiscard]] bool stampTexture(float xbase, float zbase, float x, float z,
                                  Brush *brush, float strength, float pressure,
                                  scoped_blp_texture_reference texture,
                                  QImage *image, bool paint);
  bool replace_texture(float xbase, float zbase, float x, float z, float radius,
  ...
  std::optional<tmp_edit_alpha_values> *getTempAlphamaps() {
