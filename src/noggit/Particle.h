...
public:
  ...
  ParticleSystem(Model *, const BlizzardArchive::ClientFile &f,
  ...
  void draw(glm::mat4x4 const &model_view, OpenGL::Scoped::use_program &shader,
...
struct RibbonSegment {
  ...
  float len, len0;
  RibbonSegment(::glm::vec3 pos_, float len_) : pos(pos_), len(len_) {}
};
...
public:
  RibbonEmitter(Model *, const BlizzardArchive::ClientFile &f,
