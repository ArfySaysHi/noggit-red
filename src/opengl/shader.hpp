...
struct program {
  ...
  tsl::robin_map<std::string, GLuint> const *getUniforms() const {
    return &_uniforms;
  };
  tsl::robin_map<std::string, GLuint> const *getAttributes() const {
    return &_attribs;
  };
  tsl::robin_map<GLuint, GLint> const *getUniformsIntCache() const {
    return &_uniforms_int_cache;
  };
  tsl::robin_map<GLuint, GLfloat> const *getUniformsFloatCache() const {
    return &_uniforms_float_cache;
  };
  tsl::robin_map<GLuint, bool> const *getUniformsBoolCache() const {
    return &_uniforms_bool_cache;
  };
...
struct use_program {
  ...
  void uniform(std::string const &name, glm::vec3 const *data,
               std::size_t size);
  ...
  void attrib(std::string const &name, GLuint buffer, GLsizei size, GLenum type,
              GLboolean normalized, GLsizei stride, const GLvoid *data);
  void attribi(std::string const &name, GLuint buffer, GLsizei size,
               GLenum type, GLsizei stride, const GLvoid *data);
  void attribi(std::string const &name, GLsizei size, GLenum type,
