...
namespace OpenGL {
namespace Scoped {
template <GLenum cap, GLboolean value> class bool_setter {
public:
  bool_setter();
  ~bool_setter();
...
template <GLboolean value> class depth_mask_setter {
public:
  depth_mask_setter();
  ~depth_mask_setter();
...
template <GLenum type> class buffer_binder {
public:
...
public:
  ...
  operator=(index_buffer_manual_binder const &) = delete;
...
template <std::size_t count> class deferred_upload_buffers {
public:
...
template <std::size_t count> class buffers {
public:
  buffers();
  ~buffers() = default;
...
template <std::size_t count> class deferred_upload_vertex_arrays {
public:
  ...
  deferred_upload_vertex_arrays &
  operator=(deferred_upload_vertex_arrays const &) = delete;
  deferred_upload_vertex_arrays &
  operator=(deferred_upload_vertex_arrays &&) = delete;
...
template <std::size_t count> class deferred_upload_textures {
public:
  ...
  deferred_upload_textures &
  operator=(deferred_upload_textures const &) = delete;
...
template <std::size_t count> class vertex_arrays {
public:
  vertex_arrays();
