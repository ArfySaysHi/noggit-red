...
context::scoped_setter::scoped_setter(context &context_,
    ...
    : _context(context_), _old_context(_context._current_context),
      _old_core_func(context_._4_1_core_func) {
  _context._current_context = current_context;
  _context._4_1_core_func =
      current_context->versionFunctions<QOpenGLFunctions_4_1_Core>();
...
QOpenGLContext *context::getCurrentContext() { return _current_context; }
} // namespace OpenGL
