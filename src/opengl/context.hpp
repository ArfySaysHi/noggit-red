...
struct context {
  ...
  NOGGIT_FORCEINLINE void viewport(GLint x, GLint y, GLsizei width,
                                   GLsizei height);
  ...
  NOGGIT_FORCEINLINE void readPixels(GLint x, GLint y, GLsizei width,
  ...
  NOGGIT_FORCEINLINE void texImage2D(GLenum target, GLint level,
                                     GLint internal_format, GLsizei width,
                                     GLsizei height, GLint border,
                                     GLenum format, GLenum type,
                                     GLvoid const *data);
  NOGGIT_FORCEINLINE void texSubImage2D(GLenum target, GLint level,
                                        GLint xoffset, GLint yoffset,
                                        GLsizei width, GLsizei height,
                                        GLenum format, GLenum type,
                                        const void *pixels);
  NOGGIT_FORCEINLINE void
  compressedTexSubImage2D(GLenum target, GLint level, GLint xoffset,
                          GLint yoffset, GLsizei width, GLsizei height,
                          GLenum format, GLsizei imageSize, const void *data);
  NOGGIT_FORCEINLINE void texImage3D(GLenum target, GLint level,
                                     GLint internal_format, GLsizei width,
  ...
  NOGGIT_FORCEINLINE void
  compressedTexSubImage3D(GLenum target, GLint level, GLint xoffset,
                          GLint yoffset, GLint zoffset, GLsizei width,
                          GLsizei height, GLsizei depth, GLenum format,
                          GLsizei imageSize, const void *data);
  NOGGIT_FORCEINLINE void compressedTexImage2D(GLenum target, GLint level,
                                               GLenum internalformat,
                                               GLsizei width, GLsizei height,
                                               GLint border, GLsizei imageSize,
                                               GLvoid const *data);
  NOGGIT_FORCEINLINE void
  compressedTexImage3D(GLenum target, GLint level, GLenum internalformat,
  ...
  NOGGIT_FORCEINLINE void texParameteri(GLenum target, GLenum pname,
                                        GLint param);
  NOGGIT_FORCEINLINE void texParameterf(GLenum target, GLenum pname,
                                        GLfloat param);
  NOGGIT_FORCEINLINE void texParameteriv(GLenum target, GLenum pname,
                                         GLint const *params);
  NOGGIT_FORCEINLINE void texParameterfv(GLenum target, GLenum pname,
                                         GLfloat const *params);
  NOGGIT_FORCEINLINE void texBuffer(GLenum target, GLenum internalformat,
                                    GLuint buffer);
  ...
  NOGGIT_FORCEINLINE void bindBufferRange(GLenum, GLuint, GLuint, GLintptr,
                                          GLsizeiptr);
  NOGGIT_FORCEINLINE void bufferData(GLenum target, GLsizeiptr size,
                                     GLvoid const *data, GLenum usage);
  NOGGIT_FORCEINLINE GLvoid *mapBuffer(GLenum target, GLenum access);
  NOGGIT_FORCEINLINE GLboolean unmapBuffer(GLenum);
  NOGGIT_FORCEINLINE void drawElements(GLenum mode, GLsizei count, GLenum type,
                                       GLvoid const *indices);
  NOGGIT_FORCEINLINE void drawElementsInstanced(GLenum mode, GLsizei count,
                                                GLenum type,
                                                GLvoid const *indices,
                                                GLsizei instancecount);
  NOGGIT_FORCEINLINE void drawRangeElements(GLenum mode, GLuint start,
  ...
  NOGGIT_FORCEINLINE void programString(GLenum target, GLenum format,
                                        GLsizei len, GLvoid const *pointer);
  NOGGIT_FORCEINLINE void getProgramiv(GLuint program, GLenum pname,
                                       GLint *params);
  NOGGIT_FORCEINLINE void programLocalParameter4f(GLenum, GLuint, GLfloat,
  ...
  NOGGIT_FORCEINLINE void shaderSource(GLuint shader, GLsizei count,
                                       GLchar const **string,
                                       GLint const *length);
  ...
  NOGGIT_FORCEINLINE GLint getAttribLocation(GLuint program,
                                             GLchar const *name);
  NOGGIT_FORCEINLINE void vertexAttribPointer(GLuint index, GLint size,
                                              GLenum type, GLboolean normalized,
                                              GLsizei stride,
                                              GLvoid const *pointer);
  NOGGIT_FORCEINLINE void vertexAttribIPointer(GLuint index, GLint size,
  ...
  NOGGIT_FORCEINLINE GLint getUniformLocation(GLuint program,
                                              GLchar const *name);
  NOGGIT_FORCEINLINE GLint getUniformBlockIndex(GLuint program,
                                                GLchar const *name);

  NOGGIT_FORCEINLINE void uniformBlockBinding(GLuint program,
  ...
  NOGGIT_FORCEINLINE void uniform1iv(GLint location, GLsizei count,
                                     GLint const *value);
  NOGGIT_FORCEINLINE void uniform2iv(GLint location, GLsizei count,
                                     GLint const *value);
  NOGGIT_FORCEINLINE void uniform2fv(GLint location, GLsizei count,
                                     GLfloat const *value);
  NOGGIT_FORCEINLINE void uniform3fv(GLint location, GLsizei count,
                                     GLfloat const *value);
  NOGGIT_FORCEINLINE void uniform4fv(GLint location, GLsizei count,
                                     GLfloat const *value);
  NOGGIT_FORCEINLINE void uniformMatrix4fv(GLint location, GLsizei count,
                                           GLboolean transpose,
                                           GLfloat const *value);
  ...
  NOGGIT_FORCEINLINE void colorMask(GLboolean r, GLboolean g, GLboolean b,
                                    GLboolean a);
  ...
  NOGGIT_FORCEINLINE void framebufferTexture2D(GLenum target, GLenum attachment,
  ...
  NOGGIT_FORCEINLINE void renderbufferStorage(GLenum target,
                                              GLenum internalformat,
                                              GLsizei width, GLsizei height);
  NOGGIT_FORCEINLINE void framebufferRenderbuffer(GLenum target,
                                                  GLenum attachment,
  ...
  NOGGIT_FORCEINLINE void getQueryObjectiv(GLuint id, GLenum pname,
                                           GLint *params);

  template <GLenum target>
  NOGGIT_FORCEINLINE void bufferData(GLuint buffer, GLsizeiptr size,
                                     GLvoid const *data, GLenum usage);
  template <GLenum target, typename T>
  NOGGIT_FORCEINLINE void bufferData(GLuint buffer, std::vector<T> const &data,
                                     GLenum usage);

  NOGGIT_FORCEINLINE void drawElements(GLenum mode, GLuint index_buffer,
                                       GLsizei count, GLenum type,
                                       GLvoid const *indices);

  NOGGIT_FORCEINLINE void drawArraysInstanced(GLenum mode, GLint first,
                                              GLsizei count,
                                              GLsizei instancecount);

  QOpenGLContext *getCurrentContext();

  NOGGIT_FORCEINLINE void bufferSubData(GLenum target, GLintptr offset,
                                        GLsizeiptr size, const void *data);

  template <GLenum target>
  NOGGIT_FORCEINLINE void bufferSubData(GLuint buffer, GLintptr offset,
                                        GLsizeiptr size, const void *data);
