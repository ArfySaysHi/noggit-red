...
template <typename... Args> struct QNonConstOverload {
  ...
  Q_DECL_CONSTEXPR auto
  operator()(R (T::*ptr)(Args...)) const Q_DECL_NOTHROW->decltype(ptr) {
    return ptr;
  }
...
template <typename... Args> struct QConstOverload {
  template <typename R, typename T>
  Q_DECL_CONSTEXPR auto
  operator()(R (T::*ptr)(Args...) const) const Q_DECL_NOTHROW->decltype(ptr) {
    return ptr;
  }
...
struct QOverload : QConstOverload<Args...>, QNonConstOverload<Args...> {
  ...
  template <typename R>
  Q_DECL_CONSTEXPR auto
  operator()(R (*ptr)(Args...)) const Q_DECL_NOTHROW->decltype(ptr) {
    return ptr;
  }
